...
})({"h8fm6":[function(require,module,exports,__globalThis) {
...
import * as everythingFfmpeg from '@ffmpeg/ffmpeg';
console.log("hello world");
console.log(everythingFfmpeg);*/ // From the actual documentation
...
const transcode = async ()=>{
    ...
    if (outputFileType == 'gif') {
        ...
        document.getElementById('output').appendChild(videoTag);
    }
};
...
},{}]},["h8fm6","6rimH"], "6rimH", "parcelRequire94c2")
