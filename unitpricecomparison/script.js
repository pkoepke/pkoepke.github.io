...
function addStyles() {
  console.log(document.getElementById('stylesTag'));
  ...
  if( userAgent.indexOf('iPad') > -1 || userAgent.indexOf('iPhone') > -1 || userAgent.indexOf('iPod') > -1 ) {
    ...
    document.getElementById('stylesTag').innerHTML += 'h3 {
      font-size: 3rem;
    }
    ...
    .itemLabel, .price, .units, .itemPricePerUnits, .itemName, .quantity, .unitsName {
      width: 22%;
    }
';
  } else if (!detectBobileBrowsers()) {
    //document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="./desktopStyles.css">';
    document.getElementById('stylesTag').innerHTML += 'body {
      max-width: 960px;
      margin-left: auto;
      margin-right: auto;
    }
    ...
    .multiplicationSign, .expandCollapseArrow, .addRowImg, .removeRowImg {
      height: 2rem;
      vertical-align: 10%;
    }
