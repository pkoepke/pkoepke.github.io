function addStyles() {
  ...
  if( userAgent.indexOf('iPad') > -1 || userAgent.indexOf('iPhone') > -1 || userAgent.indexOf('iPod') > -1 ) {
    ...
    document.getElementById('stylesTag').innerHTML += 'h3 {font-size: 1.3rem;} button {height: 1em; min-width: 0; max-width: 2em; vertical-align: 15%; } .itemLabel, .price, .units, .itemPricePerUnits, .itemName, .quantity, .unitsName { width: 22%; }'; // for minified and inlined version
